...
namespace IngameScript
{
	...
	// Version 0.0.3 (2019-05-11) 


	// Forewords \\__________________________________________________
	// This script is a work in progress. Whether it will see the light of day I don't know yet.
	// You are free to use it in any creation but please don't upload the script on its own to 
	// the workshop. I'd like to retain that privilege. Thank you.
